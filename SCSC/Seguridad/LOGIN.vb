...
Friend Class Login
    ...
    Private Sub ClavePaso_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles ClavePaso.Leave
        ...
        If Len(ClavePaso.Text) <> 0 Then
            ...
            If CodUsuario.Text.Trim.ToLower = "admin" Then
                If ClavePaso.Text.Trim.ToLower <> "admin" Then
    ...
    End Sub
    Private Sub CodUsuario_Leave(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CodUsuario.Leave
        ...
        If Len(CodUsuario.Text.Trim) <> 0 Then
            CodUsuario.Text = CodUsuario.Text.PadLeft(2, "0")                    
                ...
                If Ds.Tables(0).Rows.Count > 0 Then                    
                    NombreUsuario.Text = Ds.Tables(0).Rows(0)!Nombre
                ...
                Else
                    If CodUsuario.Text.ToLower = "admin" Then                        
                        ...
                        NombreUsuario.Text = "Administrador Sistema"
                        FechaServer = CDate(Ds.Tables(0).Rows(0)!Fecha).Date
                    Else
    ...
    Private Sub Login_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        fecha.Text = Format(Now, "dd/MMM/yyyy")
        CodVersion = My.Application.Info.Version.ToString
        Version.Text = CodVersion
    End Sub

    Private Sub Salir_ClickEvent(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Salir.Click
        'db.Close()
        End
    End Sub
...
Abrir:
        ...
        UsuarioAplicacion = NombreUsuario.Text.ToUpper
        gSession.Usuario = CodigoUsuario
        'a = GrabaBitacora()
        Me.Close()
        Exit Sub
ErrorAbrir:
    ...
    Private Sub ClavePaso_KeyDown(sender As Object, e As KeyEventArgs) Handles ClavePaso.KeyDown
        If e.KeyCode = Keys.Enter Then
            BtnAbrir.Focus()
        End If
    End Sub

    Private Sub CodUsuario_KeyDown(sender As Object, e As KeyEventArgs) Handles CodUsuario.KeyDown
        If e.KeyCode = Keys.Enter Then
            ClavePaso.Focus()
        End If
    End Sub
